               ...
               <img className = "aboutus" src = { require('./images/aboutus.jpg')}></img>
                ...
                <div className = "container">
                    ...
                    <div className = "row">
                        ...
                        <br></br>
                        <br></br>
                        KEF consists of a dedicated team of professionals with many combined years of experience within education, training, consulting and management, believing in quality service and professional delivery. All of the Educational Counselors at Kangaroo Education Foundation hold professional certifications, and it is a pre-requisite for all our appointed counselors.
                        <br></br>
                        <br></br>
                        At Kangaroo, we strive for perfection, helping students make best use of their abilities while taking them closer to the academic opportunities around the globe. We aim to make this institution the best nexus between Universities/Colleges and students all around the world.
                        </div>
