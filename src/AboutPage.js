               ...
               <img className = "aboutus" src = { require('./images/aboutus.jpg')}></img>
                ...
                <div className = "container">
                    ...
                    <div className = "row">
                        ...
                        <br></br>
                        <br></br>
                        At waves, we strive for perfection, helping students make best use of their abilities while taking them closer to the academic opportunities around the globe. We aim to make this institution the best nexus between Universities/Colleges and students all around the world.</p>
                        </div>
